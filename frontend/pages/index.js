...
const Index = () => {
	...
	const changeTheme = async () => {
		...
		await localStorage.setItem('bodyTheme', theme === 'light' || undefined ? 'bp3-dark' : 'bp3-body');
